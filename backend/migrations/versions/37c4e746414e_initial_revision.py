...
def upgrade() -> None:
    ...
    sa.Column('category', sa.Enum('MOOD', 'SYMPTOMS', 'APPETITE', 'DIGESTION', 'SWELLING', 'PHYSICAL_ACTIVITY', 'OTHERS', name='binarymetriccategory'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('label')
    )
    op.create_table('doctor_account_creation_requests',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('account_status', sa.Enum('PENDING', 'APPROVED', 'REJECTED', name='accountcreationrequeststatus'), server_default=sa.text("'PENDING'"), nullable=False),
    ...
    op.create_table('nutritionist_account_creation_requests',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('first_name', sa.String(length=64), nullable=False),
    sa.Column('middle_name', sa.String(length=64), nullable=True),
    sa.Column('last_name', sa.String(length=64), nullable=False),
    ...
    sa.Column('middle_name', sa.String(length=64), nullable=True),
    sa.Column('last_name', sa.String(length=64), nullable=False),
    sa.Column('role', sa.Enum('ADMIN', 'VOLUNTEER_DOCTOR', 'PREGNANT_WOMAN', 'NUTRITIONIST', name='userrole'), nullable=False),
    ...
    sa.Column('type', sa.Enum('THREAD_LIKE', 'THREAD_COMMENT', 'COMMENT_LIKE', 'COMMENT_REPLY', 'NEW_ARTICLE', 'APPOINTMENT_REMINDER', 'APPOINTMENT_REQUEST', 'PRIVATE_MESSAGE', name='notificationtype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['qualification_id'], ['nutritionist_qualifications.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('user_app_feedback',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('volunteer_doctors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('qualification_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['qualification_id'], ['doctor_qualifications.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('status', sa.Enum('PENDING_ACCEPT_REJECT', 'ACCEPTED', 'REJECTED', 'COMPLETED', name='appointmentstatus'), nullable=False),
    sa.ForeignKeyConstraint(['mother_id'], ['pregnant_women.id'], ),
    sa.ForeignKeyConstraint(['volunteer_doctor_id'], ['volunteer_doctors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('category', sa.Enum('NUTRITION', 'BODY', 'BABY', 'FEEL_GOOD', 'MEDICAL', 'EXERCISE', 'LABOUR', 'LIFESTYLE', 'RELATIONSHIPS', name='eduarticlecategory'), nullable=False),
    sa.Column('img_key', sa.String(length=255), nullable=True),
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('content_markdown', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['author_id'], ['volunteer_doctors.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('saved_volunteer_doctors',
    sa.Column('mother_id', sa.Integer(), nullable=False),
    sa.Column('volunteer_doctor_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['mother_id'], ['pregnant_women.id'], ),
    sa.ForeignKeyConstraint(['volunteer_doctor_id'], ['volunteer_doctors.id'], ),
    ...
    op.create_table('kick_tracker_data_points',
    sa.Column('id', sa.Integer(), nullable=False),
