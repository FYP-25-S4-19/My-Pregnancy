...
Revision ID: 318ac396f122
Revises:
Create Date: 2025-11-13 17:22:41.023454
...
def upgrade() -> None:
    ...
    op.create_table("scalar_metrics", sa.Column("id", sa.Integer(), nullable=False), sa.PrimaryKeyConstraint("id"))
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("PENDING", "COMPLETED", "MISSED", name="appointmentstatus"), nullable=False),
        sa.ForeignKeyConstraint(
            ["mother_id"],
            ["pregnant_women.id"],
        ),
...
def downgrade() -> None:
    ...
    op.drop_table("scalar_metric_components")
